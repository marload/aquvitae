...
def dist(teacher, student, algo, optimizer, train_ds, test_ds, iterations=1000, test_freq=200):
...
def _tensorflow_dist(teacher, student, algo, optimizer, train_ds, test_ds, iterations, test_freq):
    ...
    train_metric_log = tqdm(total=0, desc='TRAIN',
                            position=1, bar_format='{desc}')
    test_metric_log = tqdm(total=0, desc='TEST',
